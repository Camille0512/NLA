...
def check_root(delta: float):
    """
    Check whether the root of the quadratic function exist.
    :param delta: The item used to decide whether there are roots.
    :return: Whether the quadratic function has the root.
    """
